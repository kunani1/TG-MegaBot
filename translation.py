...
\n
    ...
    Hey! This is a simple Telegram All-In-One Bot that has so many function. Click /help button to Know How To Use Me.\n Made with ❤ By @Spykids_SQL"""
    RENAME_403_ERR = "<b>Sorry. You Are Not Permitted To Rename This File.\nAsk TO Him [Slogan](https://t.me/sIogan_98)</b>"
...
URL | filename | username | password</b>"""
    ...
    NO_VOID_FORMAT_FOUND = "Can You Check The Url? <b>I Am Unable To Detect Video Format From UrL.</b> If You Think This Could Be A Bug Please Report On https://t.me/Spykids_SQL"
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    CURENT_PLAN_DETAILS = """Current plan details
-----------------------------
➪Telegram ID: <code>{}</code>
➪Plan name: 75GB Per Month
➪Expires on: 1/12/2023
-----------------------------"""
